...
macha.Components.extend("_base", "widgets/googlemaps", {
    ...
    image: "icons/map.svg",
    dragHtml: '<img src="' + macha.baseUrl + 'icons/maps.png">',
...
macha.Components.extend("_base", "widgets/video", {
    name: "Video",
    attributes: ["data-component-video"],
    image: "icons/video.svg",
    dragHtml: '<img src="' + macha.baseUrl + 'icons/video.svg" width="100" height="100">', //use image for drag and swap with iframe on drop for drag performance
...
macha.Components.extend("_base", "widgets/facebookcomments", {
    ...
    dragHtml: '<img src="' + macha.baseUrl + 'icons/facebook.svg">',
...
macha.Components.extend("_base", "widgets/instagram", {
    name: "Instagram",
    attributes: ["data-component-instagram"],
    image: "icons/instagram.svg",
    drophtml: '<img src="' + macha.baseUrl + 'icons/instagram.png">',
...
macha.Components.extend("_base", "widgets/twitter", {
    name: "Twitter",
    attributes: ["data-component-twitter"],
    image: "icons/twitter.svg",
    dragHtml: '<img src="' + macha.baseUrl + 'icons/twitter.svg">',
...
macha.Components.extend("_base", "widgets/paypal", {
    name: "Paypal",
...
\
				...
				<input type="hidden" name="item_name" value="machaJs">\
...
macha.Components.extend("_base", "widgets/facebookpage", {
    name: "Facebook Page Plugin",
    attributes: ["data-component-facebookpage"],
    image: "icons/facebook.svg",
    dropHtml: '<img src="' + macha.baseUrl + 'icons/facebook.png">',
...
macha.Components.extend("_base", "widgets/chartjs", {
    name: "Chart.js",
    attributes: ["data-component-chartjs"],
    image: "icons/chart.svg",
	dragHtml: '<img src="' + macha.baseUrl + 'icons/chart.svg">',
